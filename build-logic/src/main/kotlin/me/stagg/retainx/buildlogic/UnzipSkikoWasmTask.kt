 ...
 *
 * The Compose Multiplatform Gradle plugin automatically unpacks Skiko runtime files for web targets
 * only when `compose.ui` is declared as a dependency in the main compilation. When Compose UI is
 * used solely within test source sets (or when running JS/Wasm browser tests), these binary
